...
const DefaultThought: Thought = {id: 0, sphere_id: "Gym", title: "", desc: "", type_id: 3, type: "Thought"};
const THOUGHTS: Thought[] = [{id: 0, sphere_id: "Gym", title: "Hello", desc: "I like mamba", type_id: 3, type: "Thought"}]
